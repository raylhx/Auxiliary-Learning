<template>
  <div id='cet6'>
    <leftNav v-on:getMenuTag='ToGetList' requestType="cet6"></leftNav>
    <div class='container'>
          ...
          <ul class="note-list">
            <div class="nav-wrapper">
              ...
              <el-breadcrumb separator-class="el-icon-arrow-right">
                ...
                <el-breadcrumb-item>CET6</el-breadcrumb-item>
            ...
            <li class="list" v-for="item in passageList">
              <router-link :to="'cet6/analysis/' + item.title" class="title" target="_blank">
  ...
  export default{
    ...
    methods: {
      ...
      initGetList () {
        // 初始化获取列表，不涉及参数
        // 接口参数可能还有待调整
        Axios.get('/articles/cet6').then((res) => {
          let result = res.data
          this.listAllData = result
          this.totalList = result.length
          for (let i = 0; i < result.length; i++) {
...
<style rel='stylesheet/stylus' lang='stylus'>
  /* @import '../../style/components/cet6.styl'; */
